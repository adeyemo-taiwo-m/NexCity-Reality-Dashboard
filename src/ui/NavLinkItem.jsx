...
function NavLinkItem({ icon, children, to }) {
  const baseClasses =
    "flex items-center cursor-pointer space-x-3 px-3 py-2 rounded-md transition-colors duration-150 text-neutral-600";
  const activeHoverClasses = "bg-light text-neutral-700";
