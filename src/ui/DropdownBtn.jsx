...
function DropdownBtn({ type, children }) {
  const styles = {
    lightBg:
      "flex items-center gap-1 bg-neutral-100 text-neutral-600 px-3 py-1 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-[var(--color-normal)] focus:border-[var(--color-normal)] cursor-pointer ",
    darkBg:
