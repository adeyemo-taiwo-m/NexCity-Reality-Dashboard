...
function DropdownBtn({ type, children, items = [] }) {
  ...
  const styles = {
    lightBg:
      "flex items-center px-8 py-2 gap-1 bg-neutral-100 text-neutral-600 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-[var(--color-normal)] cursor-pointer",
    darkBg:
