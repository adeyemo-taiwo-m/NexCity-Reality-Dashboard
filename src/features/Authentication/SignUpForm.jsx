...
export default function SignupForm() {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
      ...
      {/* Password */}
      <PasswordSignUp errors={errors} register={register} />
      ...
      ${
        ...
        >
          <input
            ...
            className="w-full bg-transparent outline-none text-[var(--color-neutral-700)] placeholder:text-neutral-400"
          />
          ...
          >
            {showConfirmPassword ? <HiEyeOff size={20} /> : <BsEye size={20} />}
          </button>
        </div>

        {errors.confirmPassword && (
          <InputErrorP error={errors.confirmPassword.message} />
        )}
      </div>
