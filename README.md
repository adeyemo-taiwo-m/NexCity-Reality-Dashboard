...
2. **Client State (Redux Toolkit + Sockets)**: Handles transient events that arrive _unprompted_ from the server. It stores the live notifications feed, unread notification counts, and real-time dashboard stat card deltas.
